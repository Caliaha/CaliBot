...
class Diablo3():
	def __init__(self, bot):
		...
		self.d3images['necro_female'] = "https://blzmedia-a.akamaihd.net/d3/icons/portraits/100/p6_necro_female.png"
		self.d3images['witchdoctor_female'] = "https://blzmedia-a.akamaihd.net/d3/icons/portraits/100/witchdoctor_female.png"
		self.d3images['witchdoctor_male'] = "https://blzmedia-a.akamaihd.net/d3/icons/portraits/100/witchdoctor_male.png"
	...
	def getBattletag(self, ctx, battletag):
		...
		if battletagPattern.match(battletag):
			...
			print('Added {} - {} to lastLookup'.format(ctx.author.id, battletag))
			return battletag
	...
	async def d3info(self, ctx, hero, battletag = '*'):
		...
		try:
			...
			await ctx.send(f'Failed: {e}')
			return False
		print(self.d3images[f'{j["class"]}_{("male", "female")[j["gender"]]}'])
		embed=discord.Embed(
